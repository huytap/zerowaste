      ...
      <div class="modal-body">
        <div class="container">
          ...
          <div class="step1">
            ...
            <div class="icon"><img src="images/form-icon-top.png"></div>
            <div class="box-form">
              <div class="form">
          ...
          <div class="step1 step2">
            ...
            <div class="box-form">
              ...
              <div class="form">
                ...
                <ul>
                  <li><a href="#" target="_blank"><img src="images/icon-ins.png"></a></li>
                  <li><a href="#" target="_blank"><img src="images/icon-wb.png"></a></li>
                  <li><a href="#" target="_blank"><img src="images/icon-fb.png"></a></li>
                </ul>
              </div>
              <div class="form">
          ...
          <div class="goiy text-center"><a href="#"><img src="images/btn-goiy.png"></a></div>
        </div>
        <div class="popup-footer">
          <img src="images/form-footer-bg.png" class="img-responsive">
        </div>
      </div>
    </div>
  </div>
