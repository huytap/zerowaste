...
<div class="wrapper">
   ...
   <div class="container events">
      <h3>
         eco events <a href="" class="viewmore-store hidden-lg hidden-md hidden-sm"><img src="<?php echo Yii::app()->baseUrl?>/images/viewdetail-store.png" width="20"/></a>
      </h3>
      <div class="row">
         <?php
      ...
      <div class="eco-items">
         <h3>
            eco news <a href="#" class="viewmore-store hidden-lg hidden-md hidden-sm"><img src="<?php echo Yii::app()->baseUrl?>/images/viewdetail-store.png" width="20"/></a>
         </h3>
         <div class="row">
            <?php
