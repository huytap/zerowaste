     ...
     <div class="row">
       <div class="col-md-8">
         <div class="row">
           <ul class="nav nav-tabs">
             <li class="active"><a href="#"><span><img src="<?php echo Yii::app()->baseUrl?>/images/010-placeholder.svg"></span>ĐỊA ĐIỂM</a></li>
             <li><a href="#"><span><img src="<?php echo Yii::app()->baseUrl?>/images/007-favorite.svg"></span>NHẬN XÉT</a></li>
           </ul>
         </div>
         <div class="row store">
           <div class="col-xs-12">
             <p class="stored">Bạn đã lưu <span class="usr-total-store">16</span> địa điểm zero-waste</p>
           </div>
           <?php
           $background = array(
       ...
       <div class="col-md-4">
         ...
         <div class="userinfo text-center">
           ...
           <span class="usr-setting"><img src="<?php echo Yii::app()->baseUrl;?>/images/icn_setting.svg"></span>
